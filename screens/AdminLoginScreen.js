    ...
    if (validateForm()) {
      try {
        const res = await axios.post(
          'https://ride-together-mybackend-manaal.onrender.com/api/v1/auth/login',
          { email, password }
        );
        ...
        if (res.data && res.data.success === true) {
          ...
          if (token && user._id) {
            ...
            navigation.navigate('Navigations'); // Replace 'HomeScreen' with the screen you want to navigate to
          }
        } else {
